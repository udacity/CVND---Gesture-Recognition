...
# CPU/GPU Option
The code allows you to choose whether you want to train the network using only the CPU or a GPU. Due to the very large size of the Jester dataset it is strongly recommended that you only perform the training using a GPU. The CPU mode is favorable when you just want to quickly test models. 
